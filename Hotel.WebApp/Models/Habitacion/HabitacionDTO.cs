...
namespace Hotel.WebApp.Models.Habitacion
{
    public class HabitacionDTO
    {
        ...
        public HabitacionDTO(int id, string tcNombreHabitacion, string tcDscHabitacion, int tnIdTipoHabitacion, decimal tdPrecioXnoche, string tcNomTipoHabitacion, string tcTamanoHabitacion, string tcDscAmenidades)
        {
            Id = id;
        ...
        //TipoHabitacion
        [BindProperty(Name = $"Habitacion.{nameof(TcNomTipoHabitacion)}")]
